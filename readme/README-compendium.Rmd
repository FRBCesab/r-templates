...
{{project_name}} <img src="figures/readme/compendium-sticker.png" height="120px" align="right" style="float:right; height:120px;"/>
=========================================================
...
Launch the [`make.R`](https://github.com/{{github}}/{{project_name}}/tree/{{branch}}/make.R) file with:
...
The package `{{project_name}}` is released under the {{license}} license.
...
All types of contributions are encouraged and valued. For more information, check out our [Contributor Guidelines](https://github.com/{{github}}/{{project_name}}/blob/main/CONTRIBUTING.md).
